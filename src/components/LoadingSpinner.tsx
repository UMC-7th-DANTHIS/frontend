 ...
 * - `marginTop`과 `wrapperWidth`를 통해 스피너 컨테이너의 여백과 너비를 조정할 수 있습니다.
 *
 ...
 */
const LoadingSpinner = ({ isLoading, children, marginTop = '300px', wrapperWidth }: LoadingSpinnerProps) => {
  if (isLoading) {
    return (
      <SpinnerWrapper $marginTop={marginTop} $width={wrapperWidth}>
...
const SpinnerWrapper = styled.div<{ $marginTop: string; $width?: string }>`
  display: flex;
